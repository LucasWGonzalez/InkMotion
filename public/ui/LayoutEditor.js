...
function ensureUi() {
  ...
  section.innerHTML = `
    <div class="layout-studio-head"><div><span class="eyebrow">2 · DISEÑO DE OBRA</span><h3>Elegí cómo querés imprimirla</h3><p>La vista previa se genera con el mismo motor que crea el PDF y el target WebAR. Cada opción que elijas debe verse directamente en la lámina.</p></div><button id="layout-reset" class="text-btn layout-reset" type="button">Restablecer</button></div>
    ...
    <div class="layout-studio-grid">
      ...
      <div id="layout-classic-info" class="layout-classic-info"><strong>Formato clásico activo</strong><p>InkMotion mantiene el paspartú, el marco técnico y el QR exterior en la composición validada para impresión y tracking.</p><div class="layout-benefits"><span>✓ QR con área de lectura protegida</span><span>✓ Marco técnico estable</span><span>✓ Máxima compatibilidad WebAR</span></div><button id="layout-start-custom" class="btn btn-secondary" type="button">Personalizar diseño</button></div>
