...
function ensureUi() {
  ...
  section.innerHTML = `
    <div class="layout-studio-head flow-section-heading"><span class="flow-step">02</span><div><span class="flow-kicker">PASO 2 · DISEÑO</span><h3>Elegí cómo querés imprimirla</h3><p>Personalizá la lámina y comprobá el resultado en la vista previa.</p></div><button id="layout-reset" class="text-btn layout-reset" type="button">Restablecer</button></div>
