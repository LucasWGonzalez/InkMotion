...
function ensureUi() {
  ...
  section.innerHTML = `
    <div class="layout-studio-head"><div><span class="eyebrow">PASO 2 · DISEÑO</span><h3>Elegí cómo querés imprimirla</h3><p>La vista previa muestra la misma composición que tendrá el PDF y utilizará el reconocimiento WebAR.</p></div><button id="layout-reset" class="text-btn layout-reset" type="button">Restablecer</button></div>
